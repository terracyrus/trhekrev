    ...
    public function run()
    {
        $gamechangers = [
            [
                ...
                'min_disciplines' => 7,
                'cost' => 1,
                'effect' => 'Bestimmt eine andere Gruppe, der ihr 5 (für 1) von euren Zielpunkten schenkt.',
            ...
            [
                ...
                'min_disciplines' => 8,
                'cost' => 2,
                'effect' => 'Bestimmt eine andere Gruppe, der ihr 5 (für 2) von deren Zielpunkten stehlt.',
            ...
            [
                ...
                'min_disciplines' => 9,
                'cost' => 10,
                'effect' => 'Bestimmt eine andere Gruppe, deren Zielpunktestand mit eurem gleichgesetzt wird.',
            ...
            [
                ...
                'min_disciplines' => 10,
                'cost' => 12,
                'effect' => 'Bestimmt eine andere Gruppe, deren Zielpunktestand mit eurem getauscht wird.',
            ...
            [
                ...
                'min_disciplines' => 11,
                'cost' => 14,
                'effect' => 'Schützt euch während 15 Minuten vor Gamechangern.',
            ...
            [
                ...
                'min_disciplines' => 12,
                'cost' => 20,
                'effect' => 'Die Zielrangliste wird ausgewechselt. Erreichte Punkte bleiben.',
